...
-- Updated with each value
INSERT INTO `employees` (`employeeid`,`firstname`,`lastname`,`department`,`birthdate`,`gender`,`salary`,`managerid`) VALUES
  (1, 'Rahul', 'Sharma', 'Marketing', '1988-12-05', 'M', 55000, NULL),
  (2, 'Amit', 'Patel', 'Marketing', '1972-11-25', 'M', 65000, 1),
  (3, 'Priya', NULL, 'Sales', '1986-01-05', 'F', 75000, 1),
  (4, 'Arjun', 'Singh', 'Sales', '1977-02-10', 'M', 90000, 2),
  (5, 'Neha', 'Gupta', 'Sales', '1982-02-11', 'F', 55000, 3);
